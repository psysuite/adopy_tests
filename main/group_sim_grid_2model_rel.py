...
Output: 
  - GBF files: data/output/sim_grid/2model_rel/2model_rel_S_<PSE>_<JND>.txt
  - Plots: data/output/sim_grid/2model_rel/results/
  - Excel: data/output/sim_grid/2model_rel/results/results_2model_rel.xlsx
"""
...
OUTPUT_DIR  = "../data/output/sim_grid/2model_rel"
RESULTS_DIR = "../data/output/sim_grid/2model_rel/results"
N_TRIALS    = 200
OFFSET      = 500
