...
Output: 
  - GBF files: data/output/sim_gridrnd/1model_abs/
  - Plots: data/output/sim_gridrnd/1model_abs/results/
  - Excel: data/output/sim_gridrnd/1model_abs/results/results_1model_abs.xlsx
"""
...
OUTPUT_DIR  = "../data/output/sim_gridrnd/1model_abs"
RESULTS_DIR = "../data/output/sim_gridrnd/1model_abs/results"
