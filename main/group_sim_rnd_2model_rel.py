...
Output:
  - GBF files: data/output/sim_rnd/2model_rel/
  - Plots: data/output/sim_rnd/2model_rel/results/
  - Excel: data/output/sim_rnd/2model_rel/results/results_2model_rel.xlsx
"""
...
OUTPUT_DIR  = "../data/output/sim_rnd/2model_rel"
RESULTS_DIR = "../data/output/sim_rnd/2model_rel/results"
N_SUBJECTS  = 20
N_TRIALS    = 200
OFFSET      = 500
