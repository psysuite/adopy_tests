...
Output:
  - GBF files: data/output/sim_gridrnd/ABS1/
  - Plots:     data/output/sim_gridrnd/ABS1/group_PSE_JND/results/
  - Excel:     data/output/sim_gridrnd/ABS1/group_PSE_JND/results/
  - Grid/metric plots: data/output/sim_gridrnd/ABS1/
