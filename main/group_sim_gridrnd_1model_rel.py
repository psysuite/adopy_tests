...
Output: 
  - GBF files: data/output/sim_gridrnd/1model_rel/
  - Plots: data/output/sim_gridrnd/1model_rel/results/
  - Excel: data/output/sim_gridrnd/1model_rel/results/results_1model_rel.xlsx
"""
...
OUTPUT_DIR  = "../data/output/sim_gridrnd/1model_rel"
RESULTS_DIR = "../data/output/sim_gridrnd/1model_rel/results"
