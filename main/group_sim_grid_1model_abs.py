...
Uses 1-model absolute ADOpy approach.

PSE grid: [480, 490, 500, 510, 520]
JND grid: [20, 30, 40, 50, 60]
→ 25 files × 200 trials each
Output: 
  - GBF files: data/output/sim_grid/1model_abs/1model_abs_S_<PSE>_<JND>.txt
  - Plots: data/output/sim_grid/1model_abs/results/
  - Excel: data/output/sim_grid/1model_abs/results/results_1model_abs.xlsx
"""
...
OUTPUT_DIR  = "../data/output/sim_grid/1model_abs"
RESULTS_DIR = "../data/output/sim_grid/1model_abs/results"
N_TRIALS    = 200
OFFSET      = 500
